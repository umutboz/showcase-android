...
class ToolbarShowcaseTarget extends ViewShowcaseTarget {

  ToolbarShowcaseTarget(
      Toolbar toolbar,
  ...
  private static View findNavView(Object instance) {
    ...
    for (int i = 0; i < size; ++i) {
      ...
      if (child instanceof ImageButton) {
        ...
        if (childDrawable.equals(navigationIcon)) {
          return child;
        }
      }
    }
      ...
      while (!parents.empty()) {
        ...
        for (int i = 0; i < size; ++i) {
          ...
          if (child instanceof ImageView) {
            ...
            if (childDrawable.equals(overflowDrawable)) {
              return child;
            }
          }
        }
